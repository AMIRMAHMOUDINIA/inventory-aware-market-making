...
notebooks = [
    (
        "01_market_microstructure.ipynb",
    ...
    (
        "02_event_driven_simulator.ipynb",
    ...
    (
        "03_fixed_spread_baseline.ipynb",
    ...
    (
        "04_inventory_aware_quoting.ipynb",
    ...
    (
        "05_volatility_aware_spreads.ipynb",
    ...
    (
        "08_full_evaluation_and_pnl_attribution.ipynb",
...
for filename, title, cellspec in notebooks:
    ...
    for item in cellspec:
        if isinstance(item, tuple):
            cells.append(nbf.v4.new_markdown_cell(item[0]))
        else:
            cells.append(nbf.v4.new_code_cell(item))
    nb["cells"] = cells
